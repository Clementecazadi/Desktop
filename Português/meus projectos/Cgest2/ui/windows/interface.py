...
QHBoxLayout, QFrame, QPushButton, QStackedWidget, QWidget,\
QSpacerItem, QSizePolicy, QLabel, QGraphicsOpacityEffect
...
class Ui_iterface(object):
    def UI_setup(self, janela: QMainWindow):
        ...
        self.left_button_home = Button_custome('Página Principal', icon_path='home.svg')
        self.left_button_caixa = Button_custome('Caixa', icon_path='caixa.svg')
        self.left_button_mesa = Button_custome('Mesas', icon_path='dining_table.svg', is_active=True)
        ...
        self.top_user_frame_info_lables_spacer = QSpacerItem(2, 2, QSizePolicy.Fixed, QSizePolicy.Expanding)
        ...
        self.top_user_frame_info_lable_profil = AdvencedLabel('Administrador | Editar',font_size=16, color='#afafe9')
        self.top_user_frame_info_lable_profil.setCursor(Qt.PointingHandCursor)
        ...
        self.top_user_rigth_frame_simple_view_name_user.setOpacity(6.8)
        self.top_user_rigth_frame_simple_view_button = Button_custome('', icon_path='show_user_info.svg', ste=False, height= 30, minimum_width= 30)
        ...
        self.top_user_pushbutton.setFont(get_font('josefin.ttf', 14))
        ...
        self.main_cotente = QStackedWidget()
        self.main_cotente.setStyleSheet("background-color: #13252c")
        self.page1 = QWidget(self.main_cotente)
        self.main_cotente.addWidget(self.page1)
        ...
        self.credit_bar_label = AdvencedLabel("Create by: Clemente Alberto N. Cazadi", 'josefin.ttf', 12, '#ffffff')
