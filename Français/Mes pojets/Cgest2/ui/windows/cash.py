...
class cash_page(QWidget):
    def __init__(self):
        ...
        # -------
        self.add_text_show = QLabel()
        self.add_text_show.setText('0')
        self.add_text_show_value = 0
        ...
        self.add_button_3.clicked.connect(lambda:self.add_numbers(3))
        self.add_button_4.clicked.connect(lambda:self.add_numbers(4))
        self.add_button_5.clicked.connect(lambda:self.add_numbers(5))
        self.add_button_6.clicked.connect(lambda:self.add_numbers(6))
        self.add_button_7.clicked.connect(lambda:self.add_numbers(7))
        self.add_button_8.clicked.connect(lambda:self.add_numbers(8))
        self.add_button_9.clicked.connect(lambda:self.add_numbers(9))
        self.add_button_backspace.clicked.connect(lambda:self.remove_number())
        
        self.delete_product.clicked.connect(lambda: self.action_delete_product())

    def action_delete_product(self):
        index = self.product_list.currentItem()
        print(index.text(1))
        return
    ...
    def mode(self, button_id:int = 0):
        ...
        # recetando o texo de self.add_text_show
        self.add_text_show.setText('0')
        self.add_text_show_value = 0
    ...
    def add_numbers(self, buton_id:int = 0):
        if len(self.add_text_show.text()) <= 10:
            if buton_id == 0:
                if self.add_text_show_value == 0:
                    self.add_text_show.setText('0')
                    self.add_text_show_value = 1
                else:
                    self.add_text_show.setText(self.add_text_show.text() + '0')

            elif buton_id == 1:
                if self.add_text_show_value == 0:
                    self.add_text_show.setText('1')
                    self.add_text_show_value = 1
                else:
                    self.add_text_show.setText(self.add_text_show.text() + '1')

            elif buton_id == 2:
                if self.add_text_show_value == 0:
                    self.add_text_show.setText('2')
                    self.add_text_show_value = 1
                else:
                    self.add_text_show.setText(self.add_text_show.text() + '2')

            elif buton_id == 3:
                if self.add_text_show_value == 0:
                    self.add_text_show.setText('3')
                    self.add_text_show_value = 1
                else:
                    self.add_text_show.setText(self.add_text_show.text() + '3')

            elif buton_id == 4:
                if self.add_text_show_value == 0:
                    self.add_text_show.setText('4')
                    self.add_text_show_value = 1
                else:
                     self.add_text_show.setText(self.add_text_show.text() + '4')

            elif buton_id == 5:
                if self.add_text_show_value == 0:
                    self.add_text_show.setText('5')
                    self.add_text_show_value = 1
                else:
                    self.add_text_show.setText(self.add_text_show.text() + '5')

            elif buton_id == 6:
                if self.add_text_show_value == 0:
                    self.add_text_show.setText('6')
                    self.add_text_show_value = 1
                else:
                    self.add_text_show.setText(self.add_text_show.text() + '6')
            elif buton_id == 7:
                if self.add_text_show_value == 0:
                    self.add_text_show.setText('7')
                    self.add_text_show_value = 1
                else:
                    self.add_text_show.setText(self.add_text_show.text() + '7')
            elif buton_id == 8:
                if self.add_text_show_value == 0:
                    self.add_text_show.setText('8')
                    self.add_text_show_value = 1
                else:
                    self.add_text_show.setText(self.add_text_show.text() + '8')
            elif buton_id == 9:
                if self.add_text_show_value == 0:
                    self.add_text_show.setText('5')
                    self.add_text_show_value = 1
    ...
    def remove_number(self):
        if len(self.add_text_show.text()) > 1:
            ...
            del text[-1]
            text = ''.join(text)
            self.add_text_show.setText(text)
        elif len(self.add_text_show.text()) == 1:
            self.add_text_show.setText('0')
            self.add_text_show_value = 0
