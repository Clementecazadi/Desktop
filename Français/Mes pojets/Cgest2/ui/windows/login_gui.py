...
class login_gui(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle('Entrez sur votre Cgest 2.0')
        ...
        self.left_frame_name_user = AdvencedLine_edit("Nom d'utilisateur.", font_size=16)
        self.left_frame_password_user = AdvencedLine_edit('Password.', font_size=16)
        ...
        self.left_frame_user_login = Button_custome_3('Connecter', rt=False, height=50, width=200,font_size=18)
