...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        # Esta variavel serve para os jogos contra o computador.
        self.vs = False
        # Esta variavel marcar o fim do jogo.
        self.game_finish = False
        # Esta variavel serve para o computador saber que símbolo o usuário tem X ou O.
        # Esta variavel só é importante para os jogos contra o computador e esta variavel 
    ...
    def click(self, key: str="", event: str=""):
        ...
        #    self.son = QtMultimedia.QMediaPlayer("click.wav")
        #   self.son.
        if event == "restart":
